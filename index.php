...
<?php require_once('modal.php'); ?>
  ...
  <div class="ui vertical stripe segment">
      ...
      <h3 class="ui header">3. Tell me about a technical book or article you read recently, why you liked it, and why I should read it.</h3>
      <p>I play electric guitar, i am passionate do some audio effects programming using c/c++. The book i've read was "Digital Audio with Java" by craig lindley and in the future i want to make my own app that can be downloadable at google playstore and apple store i started to do some research way back 2014.</p>
